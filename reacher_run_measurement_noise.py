...
from select_deepc.deepc_utils import (  # noqa: E402
    ...
    run_reacher_simulator_measurement_noise,
)
...
def main():
    ...
    parser.add_argument("--sigma_bar", type=float, default=0.45)
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Attempt EGL video recording even without DISPLAY.",
    )
    ...
    env = get_reacher_simulator(
        ...
        force_headless_video=bool(args.force_headless_video),
    )
    ...
    x_traj, u_traj, x_pred, u_pred, cost_obj, solve_time = run_reacher_simulator_measurement_noise(
        env,
        deepc,
        scheduler,
        seed=int(args.seed),
